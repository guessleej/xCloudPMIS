...
async function main() {
  ...
  // 專案 A 的依賴鏈：
  //   A1（分析）→ A2（設計）→ A3（閘道器）→ A4（遷移）→ A5（測試）
  //   意思是：A2 依賴 A1 完成後才能開始（完成即開始型依賴）
...
需要參考 Netflix 的微服務架構模式，特別是熔斷器和服務網格的部分。`,
