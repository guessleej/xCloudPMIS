...
const HELP_DATA = [
    ...
    sections: [
      {
        ...
        icon: '👁️',
        items: [
          { label: '分組顯示', desc: '任務依狀態自動分為「待辦、進行中、審核中、已完成」四個群組，每組可獨立折疊。' },
          { label: '拖曳排序', desc: '在同一群組內拖曳任務卡片可調整排序，方便標示個人優先處理順序。' },
          { label: '篩選列', desc: '頂部提供狀態（全部/待辦/進行中/審核中/已完成）與優先度下拉篩選，快速聚焦需要的任務；「進行中」只顯示真正進行中的任務。' },
        ],
      },
      {
        title: '新增任務',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: '巢狀留言回覆', desc: '任務詳情中的每則留言都可回覆，回覆會依階層向下堆疊；新留言會通知任務負責人與專案負責人。' },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    title: '每日進度',
    subtitle: '每日專案任務更新紀錄',
    description: '每日進度頁僅限管理員使用，會依日期彙整專案與任務的更新紀錄，方便回顧每天有哪些人更新了哪些任務。',
    sections: [
      {
        title: '進度紀錄',
        icon: '📌',
        items: [
          { label: '依日期分組', desc: '系統會將任務建立、狀態變更、欄位更新、待辦項目更新等活動依日期分組顯示。' },
          { label: '我的紀錄 / 團隊全部', desc: '可切換只看自己的更新，或查看團隊所有人的專案任務進度更新。' },
          { label: '日期與專案篩選', desc: '可調整起訖日期與專案篩選，快速定位特定時間或特定專案的更新。' },
        ],
      },
      {
        title: '前往任務',
        icon: '➡️',
        items: [
          { label: '點擊紀錄', desc: '點擊任一進度紀錄會直接前往任務看板，並自動開啟該任務的詳情側欄。' },
          { label: '專案定位', desc: '從紀錄前往任務時，系統會同步帶入所屬專案篩選，方便在看板中聚焦。' },
        ],
      },
    ],
    tips: [
      '建議管理員每天固定查看每日進度，確認團隊是否有及時更新任務狀態與待辦進展。',
      '若成員常忘記更新進度，可請他們在設定的通知偏好中開啟「每日進度提醒」。',
    ],
  },
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    title: '設定',
    subtitle: '系統與個人化設定',
    description: '設定頁目前分為四個標籤：公司資訊、個人資料、通知偏好、系統總覽；整合服務、系統狀態與資料統計已合併為同一個「系統總覽」頁。',
    sections: [
      {
        title: '公司資訊',
        icon: '🏢',
      ...
      },
      {
        ...
        items: [
          ...
          { label: '每日進度提醒', desc: '可開啟「每日專案任務更新進度提醒」，預設每天系統時間 14:00 檢查你是否已更新當天專案與任務進度。' },
        ],
      },
      {
        title: '系統總覽',
        icon: '🧩',
        items: [
          { label: '整合服務', desc: '管理 Microsoft 365 / Azure AD 連線狀態、授權資料與 OAuth 設定。' },
          { label: '系統健康', desc: '同頁查看後端服務、PostgreSQL 延遲、版本與最後操作紀錄。' },
          { label: '資料統計', desc: '同頁顯示使用者、專案、任務、里程碑、工時、留言與活動紀錄等資料量統計。' },
        ],
      },
    ],
    tips: [
      '深色／淺色模式的切換開關位於左側邊欄底部，而非在設定頁面內。',
      '若你是團隊管理員，建議定期在「系統總覽」審查整合服務連線與系統健康，確保外部服務授權未過期。',
    ],
  },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { label: '系統設定', desc: '可修改公司資訊、個人資料、通知偏好，並在系統總覽集中管理整合服務、健康狀態與資料統計。' },
