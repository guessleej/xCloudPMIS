...
const HELP_DATA = [
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: '成員管理', desc: '邀請新成員（輸入 Email 發送邀請連結）、設定成員角色（管理員/成員）、停用離職成員帳號。' },
          { label: '角色與權限', desc: '管理員：所有功能存取；成員：可讀寫任務/專案但不能管理設定。' },
        ],
      },
      {
        title: '資料與隱私',
  ...
  // ══════════════════════════════════════════════════════
  {
    ...
    description: '系統內建兩種角色：管理員（Admin）與成員（Member），各角色擁有不同的功能存取範圍。以下詳細說明權限差異。',
    sections: [
      {
        title: '管理員（Admin）',
        icon: '👑',
      ...
      },
      {
        ...
        icon: '📋',
        items: [
          { label: '建立專案', desc: '管理員 ✅ ｜ 成員 ✅' },
          { label: '編輯/刪除專案', desc: '管理員 ✅ ｜ 成員 ✅（僅自己的）' },
          { label: '建立/編輯任務', desc: '管理員 ✅ ｜ 成員 ✅' },
          { label: '指派任務給他人', desc: '管理員 ✅ ｜ 成員 ✅' },
          { label: '審核/核准', desc: '管理員 ✅ ｜ 成員 ✅（限建立者）' },
          { label: '管理成員帳號', desc: '管理員 ✅ ｜ 成員 ❌' },
          { label: '系統與工作區設定', desc: '管理員 ✅ ｜ 成員 ❌' },
          { label: '自訂欄位管理', desc: '管理員 ✅ ｜ 成員 ❌' },
          { label: '自動化規則', desc: '管理員 ✅ ｜ 成員 ❌' },
          { label: '工時記錄', desc: '管理員 ✅ ｜ 成員 ✅' },
          { label: '查看報告', desc: '管理員 ✅ ｜ 成員 ✅' },
          { label: 'Microsoft 365 整合設定', desc: '管理員 ✅ ｜ 成員 ❌' },
          { label: '個人 M365 連線', desc: '管理員 ✅ ｜ 成員 ✅' },
          { label: '匯出資料', desc: '管理員 ✅（全部） ｜ 成員 ✅（個人）' },
        ],
      },
      {
        title: '角色管理方式',
